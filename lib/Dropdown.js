...
var _DropdownStyle = require('./Dropdown-style');
...
function Dropdown(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      {style:(props.selectedOption.style ? props.selectedOption.button : _DropdownStyle2.default.button), onPress: function onPress() {
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          props.options.map(function (item, index) {
            return _react2.default.createElement(
              _reactNative.TouchableOpacity,
              { key: index, style: (item.style ? item.style : _DropdownStyle2.default.optionItem), onPress: function onPress() {
                  return props.onSelect(item, false);
                } },
              _react2.default.createElement(
                _reactNative.Text,
                { style: item.textStyle ? item.textStyle : _DropdownStyle2.default.optionText },
                item.label
              )
            );
          })
